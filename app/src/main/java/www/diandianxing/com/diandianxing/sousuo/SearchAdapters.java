...
public class SearchAdapters extends BaseAdapter {
	...
	public SearchAdapters(Context context, List<Addressbean> list){
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		viewHodler.tv_count.setText(list.get(arg0).getName());
		viewHodler.tv_title.setText(list.get(arg0).getCity());
		return arg1;
	}
